    ...
    <main id="profile">
        <header class="profile__header">
            <div class="profile__column">
                <img src="assets/images/foto_user/aryapratama/PP.jpg" style= "max-width : 40%"/>
            </div>
            <div class="profile__column">
                ...
                <ul class="profile__stats">
                    ...
                    <li class="profile__stat">
                        <span class="stat__number">291</span> followers
                    </li>
                    <li class="profile__stat">
                        <span class="stat__number">217</span> following
                    </li>
                </ul>
